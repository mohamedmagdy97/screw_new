...
class _ChatPageState extends State<ChatPage> {
  ...
  /// جلب الرسائل القديمة عند Scroll لأعلى
  void _fetchMoreMessages() async {
    ...
    if (snapshot.docs.isNotEmpty) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        double addedHeight = snapshot.docs.length * 60.0; // متوسط ارتفاع الرسالة
  ...
  /// Scroll listener للتحقق من Scroll لأعلى
          ...
          StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              return Padding(
                ...
                child: Text('${typingUsers.join(', ')} typing...',
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final showName = prevMsg == null || prevMsg['name'] != msg['name'];
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: msg['name'] == userName ? Colors.blue[100] : Colors.grey[200],
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      _formatTimestamp(msg['timestamp'] ?? Timestamp.now()),
                                      style: TextStyle(fontSize: 10, color: Colors.grey[600]),
                                    ),
                                    SizedBox(width: 5),
                                    if (seenCount > 0 && msg['name'] == userName)
                                      Text(
                                        'Seen by $seenCount',
